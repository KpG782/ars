...
import '../../domain/models/service_request.dart' show RequestStatus;
...
class ServiceRequest {
  ...
  double get mechanicEarnings {
    ...
    final platformFee = basePrice * 0.15; // 15% platform fee for mechanic
